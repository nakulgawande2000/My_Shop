function createNavigationBar() {
  ...
  bagDiv.setAttribute("class", "col-md-1");
  bagDiv.style.height = 70;
  ...
  logoText.innerHTML = "<span class='text-warning '>My-Shop</span> ";

  var labelText = document.createElement("label");
  labelText.innerHTML = "By seating at your home";
  labelText.setAttribute("class", "text-white");

  bagDiv.appendChild(img);
  parentNavDiv.appendChild(bagDiv);
  ...
  rightMenu.setAttribute("class", "col-md-3 d-flex justify-content-around align-items-center");
  rightMenu.setAttribute("style", " height:70px; margin-left:40px; font-size:20px; ");
...
function displayCart() {
  ...
  rightColDiv.setAttribute("class", "col-md-3  offset-1 d-flex flex-direction-column align-items-center justify-contain-center");
  ...
  totalItemLabel.innerText = "total Items : ";
  ...
  chekoutButton.setAttribute("class", "btn btn-warning");
  chekoutButton.setAttribute("style", "width:90%; margin:auto");
  chekoutButton.innerText = "chekout";
  ...
  rightColDiv.appendChild(chekoutButton);
...
function createSignInPage(mainDiv) {
  ...
  div.setAttribute("style", "width: 30%;min-height:300px;padding:30px;margin-auto;position:absolute;top:25%;left:33%;transform:translate:(-50%,-50%)");
  ...
  buttonInput.setAttribute("class", "btn btn-outline-success");
...
function createCart(data) {
  ...
  rowDiv.setAttribute("id", "card-row");
  ...
  for (var index in data) {
    ...
    // localStorage.setItem("cartItemList",JSON.stringify(cartItemList));
    // window.alert("product successfully add into cart")
    //}
    //else{
